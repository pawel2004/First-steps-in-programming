...
class Calculator:
    ...
    def __init__(self):
        ...
        self.button_delete = ttk.Button(self.display, text="Delete all", command=self.delete_all).pack()
    ...
    def add(self):
        self.number1 = int(self.a)
        self.a = 0
        self.screen.config(text= "0")

    def result_func(self):
        self.number2 = int(self.a)
        self.a = 0
        self.screen.config(text="0")
        self.wynik = self.number1 + self.number2
        print(self.wynik)
        self.screen.config(text= self.wynik)
